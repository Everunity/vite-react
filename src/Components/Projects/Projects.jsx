   ...
   <>
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <p className="text-sm md:text-base">
          ...
          <span className="text-orange-400">Company</span> <span className="mx-1">&gt;</span> Projects
        </p>
      </div>
    ...
    <div className="bg-green-800 py-10">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <h3 className="text-white text-2xl font-semibold mb-4">Join Us in Making a Difference</h3>
        <p className="text-gray-200 mb-6">Explore our projects and see how we are transforming the future with solar energy.</p>
